...
| 후기 관리                  | `/mypage/reviews`                                | MY-3                          | 로그인. placeholder만("준비 중" 안내)                                                                                                                                                                                                                                                                                                                                                            |
...
| 내 정보(ID-1) 마케팅 수신동의     | Figma엔 "마케팅 수신동의" 행이 있으나 회원 API 응답(`GET /me`)에 그 값 자체가 없어 뺐다. 값을 노출·수정하려면 BE 필드 추가가 먼저 필요                                                                                                                                                                                                                                             | BE 필드 추가 + PM 확정                 |
